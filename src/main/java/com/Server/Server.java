...
The folder which this file is a part of contains three other files:
    ...
    - ServerMessages: A library that helps us maintain correct tuple formatting throughout the project
 */
public class Server {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        while (true) {
            ...
            //Start a GameThread to oversee the game and put the sessionDetails in the space
